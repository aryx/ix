...
| mini-ml, the ML compiler (ocaml-light's ML, native, for arm and arm64; the target: mini-9pi) | [plan_ml.md](plans/plan_ml.md) | [notes_ml.md](tutorials/notes_ml.md) | [notes_ml_related_work.md](related-work/notes_ml_related_work.md) | `languages/ml/`, `tiny/TinyML.ml` |
