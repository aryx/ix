...
core. `tiny/TinyEditor.ml` goes further from its twin, because
...
4. **The milestones**: `mkenam`, xix's history, the session; the line
   count.
5. **`tiny/TinyEditor.ml`**, sam's language, against `sam -d`.
...
- **2026-09-23, phases 0-3 DONE: TinyEd.** `editor/`: Regex, Text,
  ...
  - **Lines: 1,264 of `.ml`** (1,007 without blanks and comments),
    ...
    partial.
- **2026-09-23, phase 5: `tiny/TinyEditor.ml`**, sam's command
