...
What mini-chidb's differential tests found in the author's chidb fork
(`~/github/chidb`, the binary `chidb`), for the author to decide. Each
is a deliberate difference in mini-chidb, which does not crash there;
checked on 2026-09-24.

| input | chidb | why | mini-chidb |
|---|---|---|---|
...
Not bugs but chidb's behaviour, kept in mini-chidb (see
